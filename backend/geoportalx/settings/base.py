...
env = environ.Env(
    ...
    RASTER_COG_TIMEOUT=(int, 60 * 60),
    RASTER_COG_MAX_BYTES=(int, 50 * 1024 * 1024 * 1024),
    RASTER_STATISTICS_MAX_SIZE=(int, 1024),
    RASTER_TILE_MIN_ZOOM=(int, 0),
    RASTER_TILE_MAX_ZOOM=(int, 22),
    TITILER_REQUEST_TIMEOUT=(float, 20.0),
    TITILER_MAX_TILE_BYTES=(int, 20 * 1024 * 1024),
    RASTER_TILE_PUBLIC_CACHE_SECONDS=(int, 60),
)
...
GDAL_TRANSLATE_EXECUTABLE = env("GDAL_TRANSLATE_EXECUTABLE", default="gdal_translate")
RASTER_COG_TIMEOUT = env("RASTER_COG_TIMEOUT")
RASTER_COG_MAX_BYTES = env("RASTER_COG_MAX_BYTES")
RASTER_STATISTICS_MAX_SIZE = env("RASTER_STATISTICS_MAX_SIZE")
RASTER_TILE_MIN_ZOOM = env("RASTER_TILE_MIN_ZOOM")
RASTER_TILE_MAX_ZOOM = env("RASTER_TILE_MAX_ZOOM")
TITILER_INTERNAL_URL = env("TITILER_INTERNAL_URL", default="http://localhost:8001")
TITILER_REQUEST_TIMEOUT = env("TITILER_REQUEST_TIMEOUT")
TITILER_MAX_TILE_BYTES = env("TITILER_MAX_TILE_BYTES")
RASTER_TILE_PUBLIC_CACHE_SECONDS = env("RASTER_TILE_PUBLIC_CACHE_SECONDS")
if min(
    RASTER_COG_TIMEOUT,
    RASTER_COG_MAX_BYTES,
    RASTER_STATISTICS_MAX_SIZE,
    TITILER_MAX_TILE_BYTES,
) <= 0:
    raise ValueError("Raster publication limits must be positive")
if RASTER_TILE_MIN_ZOOM < 0 or RASTER_TILE_MAX_ZOOM < RASTER_TILE_MIN_ZOOM:
    raise ValueError("Raster tile zoom configuration is invalid")
